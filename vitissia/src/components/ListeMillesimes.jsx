            ...
            <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            {lstMillesimes.length} vin{lstMillesimes.length > 1 ? 's' : ''} millésime{lstMillesimes.length > 1 ? 's' : ''}
                        </p>
                    </div>
                </div>
                ...
                <div className="relative">
                    ...
                    <InputText
                        ...
                        className={`w-full pl-10 pr-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition duration-300 ${darkMode ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500'
                            }`}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        ...
                        >
                            <Column
                                ...
                                headerClassName="text-xs font-semibold text-gray-600 dark:text-gray-300"
                            ></Column>
                            <Column
                                field="Annee"
                                header="Année"
