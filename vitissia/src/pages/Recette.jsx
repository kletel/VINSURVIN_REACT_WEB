          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-4 justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={toggleFavoriRecette}
                  disabled={favLoading}
                  className={`inline-flex items-center justify-center h-10 w-10 rounded-full ring-1 ring-gray-300 hover:bg-red-50 transition ${isFav ? 'text-red-600' : 'text-gray-500'}`}
                  title={isFav ? 'Retirer des favoris' : 'Ajouter aux favoris'}
                  aria-label={isFav ? 'Retirer des favoris' : 'Ajouter aux favoris'}
                >
                  <i className={`pi pi-heart ${isFav ? '' : ''}`} />
                </button>
                <button
                  onClick={enregistrerRecette}
                  disabled={saveLoading}
                  className={`inline-flex items-center justify-center h-10 w-10 rounded-full ring-1 ring-gray-300 hover:bg-emerald-50 transition ${isEnregistre ? 'text-emerald-600' : 'text-gray-500'}`}
