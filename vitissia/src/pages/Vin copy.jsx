...
const Vin = () => {
    ...
    return (
        <Layout>
            <div className="bg-[#3B0B15] font-['Work_Sans',sans-serif] ">
                            ...
                            <div className='flex-auto p-6'>
                                ...
                                {isEditing ? (
                                    <input
                                        ...
                                        readOnly={!isEditing}
                                        className="w-full bg-transparent text-white border-b border-gray-300 focus:outline-none focus:border-blue-500 text-gray-800 placeholder-gray-400 py-1 text-2xl"
                                    />
                                ) : (
                                    <h1 className="text-2xl font-medium text-white mb-2">{vin.Nom}</h1>
                                )}
                                {isEditing ? (
                                    <div className="flex items-center gap-2">
                                        <i className="pi pi-building text-white" style={{ fontSize: '1rem' }}></i>
                                        <input
                                            type="text"
                                            variant="standard"
                                            name="Domaine"
                                            ...
                                            readOnly={!isEditing}
                                            placeholder='Domaine'
                                            className="w-full bg-transparent text-white border-b border-gray-300 focus:outline-none focus:border-blue-500 text-gray-800 placeholder-gray-400 py-1 text-md font-medium mt-2"
                                        />
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-2">
